...
_DEPS = Scanner.h Parser.h TokenStream.h AstNode.h AbstractSyntaxTree.h SemanticAnalyser.h
DEPS = $(patsubst %, $(INCLUDE_DIR)/%, $(_DEPS))

_OBJS = Scanner.o Parser.o TokenStream.o AstNode.o AbstractSyntaxTree.o SemanticAnalyser.o
...
_TEST_OBJS = TestScanner.o TestParser.o Testpp.o main.o TestAST.o TestParseTree.o TestSemantics.o
TEST_OBJS = $(patsubst %, $(_TEST_BUILD_DIR)/%, $(_TEST_OBJS))

_TEST_H = TestScanner.h TestParser.h Testpp.h TestAST.h TestParseTree.h TestSemantics.h
